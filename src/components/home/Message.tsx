  ...
  return (
    <div className="message flex center column">
      <h4 className="message-title">
        Leadership - Commitment - Integrity
      </h4>
      <div className="flex left message-text">
        Marilyn has been serving the families of NE Calgary as the public school
        trustee for Wards 5 & 10 since 2017. As Vice-Chair, and now as
        Board Chair, she has provided leadership, knowledge, passion and integrity as she
